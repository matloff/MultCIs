...
---
title: "Forming Multiple Confidence Intervals in Monte Carlo Data"
author: Norm Matloff
toc: true
---
...
[]{.column-margin}
In developing/choosing a model, we may perform cross-validation, with
many replicates, in order to compare multiple algorithms, multiple sets
of hyperparameters and so on. To make our analysis statistically valid,
we can form confidence intervals (CIs). 
...
coverage probability may be much lower than 95%. This is the *multiple
inference* (MI) or *simultaneous inference* problem. In this
...
* The **qeML** functions automatically do cross-validation, via
  an argument **holdout**; here we take the default value. 
